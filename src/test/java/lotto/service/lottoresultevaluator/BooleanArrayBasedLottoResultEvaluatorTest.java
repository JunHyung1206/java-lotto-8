...
class BooleanArrayBasedLottoResultEvaluatorTest {

    private WinningNumbers draw;
    private BooleanArrayBasedLottoResultEvaluator evaluator;

    @BeforeEach
    void setUp() {
        // 당첨: 1,2,3,4,5,6 / 보너스: 7
        draw = new WinningNumbers(new Lotto(List.of(1, 2, 3, 4, 5, 6)), new BonusNumber(7));
        evaluator = new BooleanArrayBasedLottoResultEvaluator();
    }
